...
public class UserConstants
{
     ...
     * 前台用户密码加密盐
     */
    public static final String SALT_VALUE = "e5102y1025d0251925108";
    
    /**
     * 成约金比例
     */
    public static final String bonaScale = "0.5";

    /**
     * 不抢单自动取消时间(过期时间)
     */
	public static final Integer SYS_CANCEL_ORDER_TIEM = 360;
}
