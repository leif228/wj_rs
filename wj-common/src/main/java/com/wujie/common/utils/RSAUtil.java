...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("用私钥加密后：" + new String(encryptByPrivateKey));
        System.out.println("-----------------------------------");
        System.out.println("用公钥加密后：" + new String(encryptByPublicKey));
        System.out.println("-----------------------------------");
        String sign = sign(encryptByPrivateKey,privateKey);
        System.out.println("用私钥对信息生成数字签名："+sign);
        System.out.println("-----------------------------------");
        ...
        System.out.println("用公钥解密后：" + new String(decryptByPublicKey));
        System.out.println("-----------------------------------");
        System.out.println("用私钥解密后：" + new String(decryptByPrivateKey));
