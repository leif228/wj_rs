package com.wujie.hc.app.framework.bootstrap;

import com.wujie.hc.app.business.util.jdbc.impl.SHCommonDaoImpl;
...
public class BootstrapReadData extends BaseServiceImpl implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Thread thread=new Thread(()-> {
			try {
				Class<?> clazz = Class.forName("com.wujie.hc.app.business.util.system.SystemConfig");
