package com.wujie.mc.app.framework.bootstrap;

import com.wujie.mc.app.business.util.jdbc.impl.SHCommonDaoImpl;
import com.wujie.mc.app.framework.util.base.impl.BaseServiceImpl;
...
public class BootstrapReadData extends BaseServiceImpl implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Thread thread=new Thread(()-> {
			try {
				Class<?> clazz = Class.forName("com.wujie.mc.app.business.util.system.SystemConfig");
