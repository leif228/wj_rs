package com.wujie.pcclient.app.business.util.date;
...
public class DateUtil {
	 ...
	 * @Return long 技术按结果
	 */
	public static long differenceTime(Date oldTime, Date nowTime, com.wujie.pcclient.app.business.util.date.TimeTypeEnum type){
	 ...
	 * @Return java.util.Date
	 */
	public static Date calculatingTime(Date time, int num, TimeTypeEnum timeTypeEnum, com.wujie.pcclient.app.business.util.date.CalculateTypeEnum calculateTypeEnum){
