package com.wujie.pcclient.app.framework.exception;

import com.wujie.pcclient.app.business.enums.ErrorEnum;
import com.wujie.pcclient.app.business.vo.ResultVo;
...
public class GlobalExceptionHandler {
    ...
    private ResultVo<Object> handlerErrorInfo(HttpServletRequest request, Exception e) {
        ...
        if (e instanceof com.wujie.pcclient.app.framework.exception.CustomException) {
